...
public class VkDisplayPropertiesKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_POINTER.withName("display"),
        glfw3_h.C_POINTER.withName("displayName"),
        ...
        glfw3_h.C_INT.withName("planeReorderPossible"),
        glfw3_h.C_INT.withName("persistentContent"),

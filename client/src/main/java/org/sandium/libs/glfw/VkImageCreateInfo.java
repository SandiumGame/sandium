...
public class VkImageCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("imageType"),
        glfw3_h.C_INT.withName("format"),
        VkExtent3D.layout().withName("extent"),
        glfw3_h.C_INT.withName("mipLevels"),
        glfw3_h.C_INT.withName("arrayLayers"),
        glfw3_h.C_INT.withName("samples"),
        glfw3_h.C_INT.withName("tiling"),
        glfw3_h.C_INT.withName("usage"),
        glfw3_h.C_INT.withName("sharingMode"),
        glfw3_h.C_INT.withName("queueFamilyIndexCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pQueueFamilyIndices"),
        glfw3_h.C_INT.withName("initialLayout"),
        MemoryLayout.paddingLayout(4)

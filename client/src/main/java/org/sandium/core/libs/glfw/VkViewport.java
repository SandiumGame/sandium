...
public class VkViewport {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_FLOAT.withName("x"),
        glfw3_h.C_FLOAT.withName("y"),
        glfw3_h.C_FLOAT.withName("width"),
        glfw3_h.C_FLOAT.withName("height"),
        glfw3_h.C_FLOAT.withName("minDepth"),
        glfw3_h.C_FLOAT.withName("maxDepth")
    ).withName("VkViewport");

...
public class VkCooperativeMatrixPropertiesNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("MSize"),
        glfw3_h.C_INT.withName("NSize"),
        glfw3_h.C_INT.withName("KSize"),
        glfw3_h.C_INT.withName("AType"),
        glfw3_h.C_INT.withName("BType"),
        glfw3_h.C_INT.withName("CType"),
        glfw3_h.C_INT.withName("DType"),
        glfw3_h.C_INT.withName("scope")

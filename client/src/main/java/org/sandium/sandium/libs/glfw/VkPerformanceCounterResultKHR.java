...
public class VkPerformanceCounterResultKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        glfw3_h.C_INT.withName("int32"),
        glfw3_h.C_LONG.withName("int64"),
        glfw3_h.C_INT.withName("uint32"),
        glfw3_h.C_LONG.withName("uint64"),
        glfw3_h.C_FLOAT.withName("float32"),
        glfw3_h.C_DOUBLE.withName("float64")

...
public class VkPhysicalDeviceProperties {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("driverVersion"),
        glfw3_h.C_INT.withName("vendorID"),
        glfw3_h.C_INT.withName("deviceID"),
        glfw3_h.C_INT.withName("deviceType"),
        MemoryLayout.sequenceLayout(256, glfw3_h.C_CHAR).withName("deviceName"),
        MemoryLayout.sequenceLayout(16, glfw3_h.C_CHAR).withName("pipelineCacheUUID"),

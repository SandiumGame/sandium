...
public class VkPhysicalDeviceInlineUniformBlockPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("maxInlineUniformBlockSize"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorInlineUniformBlocks"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindInlineUniformBlocks"),
        glfw3_h.C_INT.withName("maxDescriptorSetInlineUniformBlocks"),
        glfw3_h.C_INT.withName("maxDescriptorSetUpdateAfterBindInlineUniformBlocks"),
        MemoryLayout.paddingLayout(4)
    ).withName("VkPhysicalDeviceInlineUniformBlockPropertiesEXT");

...
public class VkSubpassDescription2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("viewMask"),
        glfw3_h.C_INT.withName("inputAttachmentCount"),
        glfw3_h.C_POINTER.withName("pInputAttachments"),
        glfw3_h.C_INT.withName("colorAttachmentCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pColorAttachments"),
        glfw3_h.C_POINTER.withName("pResolveAttachments"),
        glfw3_h.C_POINTER.withName("pDepthStencilAttachment"),
        glfw3_h.C_INT.withName("preserveAttachmentCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pPreserveAttachments")

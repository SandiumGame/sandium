 ...
 * }
 */
public class PFNGLMATRIXMULT3X2FNVPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLMATRIXMULT3X2FNVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLMATRIXMULT3X2FNVPROC.Function fi, Arena arena) {

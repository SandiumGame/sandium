...
public class VkPhysicalDeviceConservativeRasterizationPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_FLOAT.withName("primitiveOverestimationSize"),
        glfw3_h.C_FLOAT.withName("maxExtraPrimitiveOverestimationSize"),
        glfw3_h.C_FLOAT.withName("extraPrimitiveOverestimationSizeGranularity"),
        glfw3_h.C_INT.withName("primitiveUnderestimation"),
        glfw3_h.C_INT.withName("conservativePointAndLineRasterization"),
        glfw3_h.C_INT.withName("degenerateTrianglesRasterized"),
        glfw3_h.C_INT.withName("degenerateLinesRasterized"),
        glfw3_h.C_INT.withName("fullyCoveredFragmentShaderInputVariable"),
        glfw3_h.C_INT.withName("conservativeRasterizationPostDepthCoverage"),
        MemoryLayout.paddingLayout(4)

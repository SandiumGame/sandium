...
public class VkStencilOpState {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_INT.withName("failOp"),
        glfw3_h.C_INT.withName("passOp"),
        glfw3_h.C_INT.withName("depthFailOp"),
        glfw3_h.C_INT.withName("compareOp"),
        glfw3_h.C_INT.withName("compareMask"),
        glfw3_h.C_INT.withName("writeMask"),
        glfw3_h.C_INT.withName("reference")

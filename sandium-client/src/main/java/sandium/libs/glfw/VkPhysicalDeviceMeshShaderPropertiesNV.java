...
public class VkPhysicalDeviceMeshShaderPropertiesNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("maxDrawMeshTasksCount"),
        glfw3_h.C_INT.withName("maxTaskWorkGroupInvocations"),
        MemoryLayout.sequenceLayout(3, glfw3_h.C_INT).withName("maxTaskWorkGroupSize"),
        glfw3_h.C_INT.withName("maxTaskTotalMemorySize"),
        glfw3_h.C_INT.withName("maxTaskOutputCount"),
        glfw3_h.C_INT.withName("maxMeshWorkGroupInvocations"),
        MemoryLayout.sequenceLayout(3, glfw3_h.C_INT).withName("maxMeshWorkGroupSize"),
        glfw3_h.C_INT.withName("maxMeshTotalMemorySize"),
        glfw3_h.C_INT.withName("maxMeshOutputVertices"),
        glfw3_h.C_INT.withName("maxMeshOutputPrimitives"),
        glfw3_h.C_INT.withName("maxMeshMultiviewViewCount"),
        glfw3_h.C_INT.withName("meshOutputPerVertexGranularity"),
        glfw3_h.C_INT.withName("meshOutputPerPrimitiveGranularity"),
        MemoryLayout.paddingLayout(4)

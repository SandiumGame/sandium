...
public class VkDebugUtilsMessengerCallbackDataEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pMessageIdName"),
        glfw3_h.C_INT.withName("messageIdNumber"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pMessage"),
        glfw3_h.C_INT.withName("queueLabelCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pQueueLabels"),
        glfw3_h.C_INT.withName("cmdBufLabelCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pCmdBufLabels"),
        glfw3_h.C_INT.withName("objectCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pObjects")

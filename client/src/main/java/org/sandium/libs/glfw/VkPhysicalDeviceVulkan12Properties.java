...
public class VkPhysicalDeviceVulkan12Properties {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("driverID"),
        MemoryLayout.sequenceLayout(256, glfw3_h.C_CHAR).withName("driverName"),
        MemoryLayout.sequenceLayout(256, glfw3_h.C_CHAR).withName("driverInfo"),
        VkConformanceVersion.layout().withName("conformanceVersion"),
        glfw3_h.C_INT.withName("denormBehaviorIndependence"),
        glfw3_h.C_INT.withName("roundingModeIndependence"),
        glfw3_h.C_INT.withName("shaderSignedZeroInfNanPreserveFloat16"),
        glfw3_h.C_INT.withName("shaderSignedZeroInfNanPreserveFloat32"),
        glfw3_h.C_INT.withName("shaderSignedZeroInfNanPreserveFloat64"),
        glfw3_h.C_INT.withName("shaderDenormPreserveFloat16"),
        glfw3_h.C_INT.withName("shaderDenormPreserveFloat32"),
        glfw3_h.C_INT.withName("shaderDenormPreserveFloat64"),
        glfw3_h.C_INT.withName("shaderDenormFlushToZeroFloat16"),
        glfw3_h.C_INT.withName("shaderDenormFlushToZeroFloat32"),
        glfw3_h.C_INT.withName("shaderDenormFlushToZeroFloat64"),
        glfw3_h.C_INT.withName("shaderRoundingModeRTEFloat16"),
        glfw3_h.C_INT.withName("shaderRoundingModeRTEFloat32"),
        glfw3_h.C_INT.withName("shaderRoundingModeRTEFloat64"),
        glfw3_h.C_INT.withName("shaderRoundingModeRTZFloat16"),
        glfw3_h.C_INT.withName("shaderRoundingModeRTZFloat32"),
        glfw3_h.C_INT.withName("shaderRoundingModeRTZFloat64"),
        glfw3_h.C_INT.withName("maxUpdateAfterBindDescriptorsInAllPools"),
        glfw3_h.C_INT.withName("shaderUniformBufferArrayNonUniformIndexingNative"),
        glfw3_h.C_INT.withName("shaderSampledImageArrayNonUniformIndexingNative"),
        glfw3_h.C_INT.withName("shaderStorageBufferArrayNonUniformIndexingNative"),
        glfw3_h.C_INT.withName("shaderStorageImageArrayNonUniformIndexingNative"),
        glfw3_h.C_INT.withName("shaderInputAttachmentArrayNonUniformIndexingNative"),
        glfw3_h.C_INT.withName("robustBufferAccessUpdateAfterBind"),
        glfw3_h.C_INT.withName("quadDivergentImplicitLod"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindSamplers"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindUniformBuffers"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindStorageBuffers"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindSampledImages"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindStorageImages"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorUpdateAfterBindInputAttachments"),
        glfw3_h.C_INT.withName("maxPerStageUpdateAfterBindResources"),
        glfw3_h.C_INT.withName("maxDescriptorSetUpdateAfterBindSamplers"),
        glfw3_h.C_INT.withName("maxDescriptorSetUpdateAfterBindUniformBuffers"),
        glfw3_h.C_INT.withName("maxDescriptorSetUpdateAfterBindUniformBuffersDynamic"),
        glfw3_h.C_INT.withName("maxDescriptorSetUpdateAfterBindStorageBuffers"),
        glfw3_h.C_INT.withName("maxDescriptorSetUpdateAfterBindStorageBuffersDynamic"),
        glfw3_h.C_INT.withName("maxDescriptorSetUpdateAfterBindSampledImages"),
        glfw3_h.C_INT.withName("maxDescriptorSetUpdateAfterBindStorageImages"),
        glfw3_h.C_INT.withName("maxDescriptorSetUpdateAfterBindInputAttachments"),
        glfw3_h.C_INT.withName("supportedDepthResolveModes"),
        glfw3_h.C_INT.withName("supportedStencilResolveModes"),
        glfw3_h.C_INT.withName("independentResolveNone"),
        glfw3_h.C_INT.withName("independentResolve"),
        glfw3_h.C_INT.withName("filterMinmaxSingleComponentFormats"),
        glfw3_h.C_INT.withName("filterMinmaxImageComponentMapping"),
        glfw3_h.C_LONG.withName("maxTimelineSemaphoreValueDifference"),
        glfw3_h.C_INT.withName("framebufferIntegerColorSampleCounts"),
        MemoryLayout.paddingLayout(4)

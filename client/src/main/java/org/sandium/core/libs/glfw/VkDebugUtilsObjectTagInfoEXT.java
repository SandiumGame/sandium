...
public class VkDebugUtilsObjectTagInfoEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("objectType"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_LONG.withName("objectHandle"),
        glfw3_h.C_LONG.withName("tagName"),
        glfw3_h.C_LONG.withName("tagSize"),
        glfw3_h.C_POINTER.withName("pTag")

...
public class VkPhysicalDeviceRayTracingPropertiesNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("shaderGroupHandleSize"),
        glfw3_h.C_INT.withName("maxRecursionDepth"),
        glfw3_h.C_INT.withName("maxShaderGroupStride"),
        glfw3_h.C_INT.withName("shaderGroupBaseAlignment"),
        glfw3_h.C_LONG.withName("maxGeometryCount"),
        glfw3_h.C_LONG.withName("maxInstanceCount"),
        glfw3_h.C_LONG.withName("maxTriangleCount"),
        glfw3_h.C_INT.withName("maxDescriptorSetAccelerationStructures"),
        MemoryLayout.paddingLayout(4)

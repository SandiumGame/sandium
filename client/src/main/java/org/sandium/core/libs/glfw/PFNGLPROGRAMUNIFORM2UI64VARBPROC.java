 ...
 * }
 */
public class PFNGLPROGRAMUNIFORM2UI64VARBPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLPROGRAMUNIFORM2UI64VARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLPROGRAMUNIFORM2UI64VARBPROC.Function fi, Arena arena) {

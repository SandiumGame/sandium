...
public class VkAllocationCallbacks {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_POINTER.withName("pfnAllocation"),
        glfw3_h.C_POINTER.withName("pfnReallocation"),
        glfw3_h.C_POINTER.withName("pfnFree"),
        glfw3_h.C_POINTER.withName("pfnInternalAllocation"),
        glfw3_h.C_POINTER.withName("pfnInternalFree")

 ...
 * }
 */
public class PFNGLMULTITEXCOORD1HVNVPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLMULTITEXCOORD1HVNVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLMULTITEXCOORD1HVNVPROC.Function fi, Arena arena) {

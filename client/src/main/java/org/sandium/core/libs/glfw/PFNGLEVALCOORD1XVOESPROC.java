 ...
 * }
 */
public class PFNGLEVALCOORD1XVOESPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLEVALCOORD1XVOESPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLEVALCOORD1XVOESPROC.Function fi, Arena arena) {

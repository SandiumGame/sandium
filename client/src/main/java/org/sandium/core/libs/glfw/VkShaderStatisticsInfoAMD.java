...
public class VkShaderStatisticsInfoAMD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_INT.withName("shaderStageMask"),
        MemoryLayout.paddingLayout(4),
        VkShaderResourceUsageAMD.layout().withName("resourceUsage"),
        glfw3_h.C_INT.withName("numPhysicalVgprs"),
        glfw3_h.C_INT.withName("numPhysicalSgprs"),
        glfw3_h.C_INT.withName("numAvailableVgprs"),
        glfw3_h.C_INT.withName("numAvailableSgprs"),
        MemoryLayout.sequenceLayout(3, glfw3_h.C_INT).withName("computeWorkGroupSize"),
        MemoryLayout.paddingLayout(4)

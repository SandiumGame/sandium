...
public class VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("fragmentShaderSampleInterlock"),
        glfw3_h.C_INT.withName("fragmentShaderPixelInterlock"),
        glfw3_h.C_INT.withName("fragmentShaderShadingRateInterlock"),
        MemoryLayout.paddingLayout(4)

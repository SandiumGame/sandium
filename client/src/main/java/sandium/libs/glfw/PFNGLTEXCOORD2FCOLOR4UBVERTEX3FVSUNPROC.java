 ...
 * }
 */
public class PFNGLTEXCOORD2FCOLOR4UBVERTEX3FVSUNPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLTEXCOORD2FCOLOR4UBVERTEX3FVSUNPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLTEXCOORD2FCOLOR4UBVERTEX3FVSUNPROC.Function fi, Arena arena) {

...
public class VkPipelineColorBlendAttachmentState {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_INT.withName("blendEnable"),
        glfw3_h.C_INT.withName("srcColorBlendFactor"),
        glfw3_h.C_INT.withName("dstColorBlendFactor"),
        glfw3_h.C_INT.withName("colorBlendOp"),
        glfw3_h.C_INT.withName("srcAlphaBlendFactor"),
        glfw3_h.C_INT.withName("dstAlphaBlendFactor"),
        glfw3_h.C_INT.withName("alphaBlendOp"),
        glfw3_h.C_INT.withName("colorWriteMask")

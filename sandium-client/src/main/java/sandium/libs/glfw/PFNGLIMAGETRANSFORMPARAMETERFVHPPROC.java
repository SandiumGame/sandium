 ...
 * }
 */
public class PFNGLIMAGETRANSFORMPARAMETERFVHPPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLIMAGETRANSFORMPARAMETERFVHPPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLIMAGETRANSFORMPARAMETERFVHPPROC.Function fi, Arena arena) {

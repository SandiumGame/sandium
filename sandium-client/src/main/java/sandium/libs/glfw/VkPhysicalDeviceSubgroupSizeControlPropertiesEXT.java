...
public class VkPhysicalDeviceSubgroupSizeControlPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("minSubgroupSize"),
        glfw3_h.C_INT.withName("maxSubgroupSize"),
        glfw3_h.C_INT.withName("maxComputeWorkgroupSubgroups"),
        glfw3_h.C_INT.withName("requiredSubgroupSizeStages")
    ).withName("VkPhysicalDeviceSubgroupSizeControlPropertiesEXT");

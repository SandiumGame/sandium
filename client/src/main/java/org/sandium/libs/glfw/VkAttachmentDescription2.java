...
public class VkAttachmentDescription2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("loadOp"),
        glfw3_h.C_INT.withName("storeOp"),
        glfw3_h.C_INT.withName("stencilLoadOp"),
        glfw3_h.C_INT.withName("stencilStoreOp"),
        glfw3_h.C_INT.withName("initialLayout"),
        glfw3_h.C_INT.withName("finalLayout"),
        MemoryLayout.paddingLayout(4)

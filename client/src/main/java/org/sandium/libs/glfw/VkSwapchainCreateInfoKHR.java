...
public class VkSwapchainCreateInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("surface"),
        glfw3_h.C_INT.withName("minImageCount"),
        glfw3_h.C_INT.withName("imageFormat"),
        glfw3_h.C_INT.withName("imageColorSpace"),
        VkExtent2D.layout().withName("imageExtent"),
        glfw3_h.C_INT.withName("imageArrayLayers"),
        glfw3_h.C_INT.withName("imageUsage"),
        glfw3_h.C_INT.withName("imageSharingMode"),
        glfw3_h.C_INT.withName("queueFamilyIndexCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pQueueFamilyIndices"),
        glfw3_h.C_INT.withName("preTransform"),
        glfw3_h.C_INT.withName("compositeAlpha"),
        glfw3_h.C_INT.withName("presentMode"),
        glfw3_h.C_INT.withName("clipped"),
        glfw3_h.C_POINTER.withName("oldSwapchain")

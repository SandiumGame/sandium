...
public class VkSamplerCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("magFilter"),
        glfw3_h.C_INT.withName("minFilter"),
        glfw3_h.C_INT.withName("mipmapMode"),
        glfw3_h.C_INT.withName("addressModeU"),
        glfw3_h.C_INT.withName("addressModeV"),
        glfw3_h.C_INT.withName("addressModeW"),
        glfw3_h.C_FLOAT.withName("mipLodBias"),
        glfw3_h.C_INT.withName("anisotropyEnable"),
        glfw3_h.C_FLOAT.withName("maxAnisotropy"),
        glfw3_h.C_INT.withName("compareEnable"),
        glfw3_h.C_INT.withName("compareOp"),
        glfw3_h.C_FLOAT.withName("minLod"),
        glfw3_h.C_FLOAT.withName("maxLod"),
        glfw3_h.C_INT.withName("borderColor"),
        glfw3_h.C_INT.withName("unnormalizedCoordinates")

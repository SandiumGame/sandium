...
public class VkGeometryTrianglesNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_POINTER.withName("vertexData"),
        glfw3_h.C_LONG.withName("vertexOffset"),
        glfw3_h.C_INT.withName("vertexCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_LONG.withName("vertexStride"),
        glfw3_h.C_INT.withName("vertexFormat"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("indexData"),
        glfw3_h.C_LONG.withName("indexOffset"),
        glfw3_h.C_INT.withName("indexCount"),
        glfw3_h.C_INT.withName("indexType"),
        glfw3_h.C_POINTER.withName("transformData"),
        glfw3_h.C_LONG.withName("transformOffset")

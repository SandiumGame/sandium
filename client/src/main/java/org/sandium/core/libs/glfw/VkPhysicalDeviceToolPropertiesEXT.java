...
public class VkPhysicalDeviceToolPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(256, glfw3_h.C_CHAR).withName("name"),
        MemoryLayout.sequenceLayout(256, glfw3_h.C_CHAR).withName("version"),
        glfw3_h.C_INT.withName("purposes"),
        MemoryLayout.sequenceLayout(256, glfw3_h.C_CHAR).withName("description"),
        MemoryLayout.sequenceLayout(256, glfw3_h.C_CHAR).withName("layer"),
        MemoryLayout.paddingLayout(4)

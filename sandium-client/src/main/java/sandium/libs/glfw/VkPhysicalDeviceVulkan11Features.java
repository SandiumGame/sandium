...
public class VkPhysicalDeviceVulkan11Features {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("storageBuffer16BitAccess"),
        glfw3_h.C_INT.withName("uniformAndStorageBuffer16BitAccess"),
        glfw3_h.C_INT.withName("storagePushConstant16"),
        glfw3_h.C_INT.withName("storageInputOutput16"),
        glfw3_h.C_INT.withName("multiview"),
        glfw3_h.C_INT.withName("multiviewGeometryShader"),
        glfw3_h.C_INT.withName("multiviewTessellationShader"),
        glfw3_h.C_INT.withName("variablePointersStorageBuffer"),
        glfw3_h.C_INT.withName("variablePointers"),
        glfw3_h.C_INT.withName("protectedMemory"),
        glfw3_h.C_INT.withName("samplerYcbcrConversion"),
        glfw3_h.C_INT.withName("shaderDrawParameters")

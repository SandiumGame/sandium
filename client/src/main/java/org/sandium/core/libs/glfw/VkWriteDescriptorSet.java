...
public class VkWriteDescriptorSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_POINTER.withName("dstSet"),
        glfw3_h.C_INT.withName("dstBinding"),
        glfw3_h.C_INT.withName("dstArrayElement"),
        glfw3_h.C_INT.withName("descriptorCount"),
        glfw3_h.C_INT.withName("descriptorType"),
        glfw3_h.C_POINTER.withName("pImageInfo"),
        glfw3_h.C_POINTER.withName("pBufferInfo"),
        glfw3_h.C_POINTER.withName("pTexelBufferView")

...
/**
 * {@snippet lang=c :
 * typedef VkResult (*PFN_vkGetPhysicalDeviceCalibrateableTimeDomainsEXT)(VkPhysicalDevice, uint32_t *, VkTimeDomainEXT *)
 * }
 */
public class PFN_vkGetPhysicalDeviceCalibrateableTimeDomainsEXT {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFN_vkGetPhysicalDeviceCalibrateableTimeDomainsEXT.Function.class, "apply", $DESC);

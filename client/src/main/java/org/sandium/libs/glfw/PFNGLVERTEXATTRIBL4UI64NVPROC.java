 ...
 * }
 */
public class PFNGLVERTEXATTRIBL4UI64NVPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLVERTEXATTRIBL4UI64NVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLVERTEXATTRIBL4UI64NVPROC.Function fi, Arena arena) {

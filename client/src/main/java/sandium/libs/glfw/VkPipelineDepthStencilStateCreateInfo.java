...
public class VkPipelineDepthStencilStateCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("depthTestEnable"),
        glfw3_h.C_INT.withName("depthWriteEnable"),
        glfw3_h.C_INT.withName("depthCompareOp"),
        glfw3_h.C_INT.withName("depthBoundsTestEnable"),
        glfw3_h.C_INT.withName("stencilTestEnable"),
        VkStencilOpState.layout().withName("front"),
        VkStencilOpState.layout().withName("back"),
        glfw3_h.C_FLOAT.withName("minDepthBounds"),
        glfw3_h.C_FLOAT.withName("maxDepthBounds")

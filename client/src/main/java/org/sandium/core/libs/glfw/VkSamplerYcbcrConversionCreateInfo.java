...
public class VkSamplerYcbcrConversionCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("ycbcrModel"),
        glfw3_h.C_INT.withName("ycbcrRange"),
        VkComponentMapping.layout().withName("components"),
        glfw3_h.C_INT.withName("xChromaOffset"),
        glfw3_h.C_INT.withName("yChromaOffset"),
        glfw3_h.C_INT.withName("chromaFilter"),
        glfw3_h.C_INT.withName("forceExplicitReconstruction"),
        MemoryLayout.paddingLayout(4)

...
public class VkPipelineMultisampleStateCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("rasterizationSamples"),
        glfw3_h.C_INT.withName("sampleShadingEnable"),
        glfw3_h.C_FLOAT.withName("minSampleShading"),
        glfw3_h.C_POINTER.withName("pSampleMask"),
        glfw3_h.C_INT.withName("alphaToCoverageEnable"),
        glfw3_h.C_INT.withName("alphaToOneEnable")

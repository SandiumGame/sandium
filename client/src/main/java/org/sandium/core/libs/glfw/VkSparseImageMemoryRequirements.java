...
public class VkSparseImageMemoryRequirements {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("imageMipTailFirstLod"),
        glfw3_h.C_LONG.withName("imageMipTailSize"),
        glfw3_h.C_LONG.withName("imageMipTailOffset"),
        glfw3_h.C_LONG.withName("imageMipTailStride")

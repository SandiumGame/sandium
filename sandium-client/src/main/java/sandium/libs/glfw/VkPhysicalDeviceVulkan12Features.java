...
public class VkPhysicalDeviceVulkan12Features {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("samplerMirrorClampToEdge"),
        glfw3_h.C_INT.withName("drawIndirectCount"),
        glfw3_h.C_INT.withName("storageBuffer8BitAccess"),
        glfw3_h.C_INT.withName("uniformAndStorageBuffer8BitAccess"),
        glfw3_h.C_INT.withName("storagePushConstant8"),
        glfw3_h.C_INT.withName("shaderBufferInt64Atomics"),
        glfw3_h.C_INT.withName("shaderSharedInt64Atomics"),
        glfw3_h.C_INT.withName("shaderFloat16"),
        glfw3_h.C_INT.withName("shaderInt8"),
        glfw3_h.C_INT.withName("descriptorIndexing"),
        glfw3_h.C_INT.withName("shaderInputAttachmentArrayDynamicIndexing"),
        glfw3_h.C_INT.withName("shaderUniformTexelBufferArrayDynamicIndexing"),
        glfw3_h.C_INT.withName("shaderStorageTexelBufferArrayDynamicIndexing"),
        glfw3_h.C_INT.withName("shaderUniformBufferArrayNonUniformIndexing"),
        glfw3_h.C_INT.withName("shaderSampledImageArrayNonUniformIndexing"),
        glfw3_h.C_INT.withName("shaderStorageBufferArrayNonUniformIndexing"),
        glfw3_h.C_INT.withName("shaderStorageImageArrayNonUniformIndexing"),
        glfw3_h.C_INT.withName("shaderInputAttachmentArrayNonUniformIndexing"),
        glfw3_h.C_INT.withName("shaderUniformTexelBufferArrayNonUniformIndexing"),
        glfw3_h.C_INT.withName("shaderStorageTexelBufferArrayNonUniformIndexing"),
        glfw3_h.C_INT.withName("descriptorBindingUniformBufferUpdateAfterBind"),
        glfw3_h.C_INT.withName("descriptorBindingSampledImageUpdateAfterBind"),
        glfw3_h.C_INT.withName("descriptorBindingStorageImageUpdateAfterBind"),
        glfw3_h.C_INT.withName("descriptorBindingStorageBufferUpdateAfterBind"),
        glfw3_h.C_INT.withName("descriptorBindingUniformTexelBufferUpdateAfterBind"),
        glfw3_h.C_INT.withName("descriptorBindingStorageTexelBufferUpdateAfterBind"),
        glfw3_h.C_INT.withName("descriptorBindingUpdateUnusedWhilePending"),
        glfw3_h.C_INT.withName("descriptorBindingPartiallyBound"),
        glfw3_h.C_INT.withName("descriptorBindingVariableDescriptorCount"),
        glfw3_h.C_INT.withName("runtimeDescriptorArray"),
        glfw3_h.C_INT.withName("samplerFilterMinmax"),
        glfw3_h.C_INT.withName("scalarBlockLayout"),
        glfw3_h.C_INT.withName("imagelessFramebuffer"),
        glfw3_h.C_INT.withName("uniformBufferStandardLayout"),
        glfw3_h.C_INT.withName("shaderSubgroupExtendedTypes"),
        glfw3_h.C_INT.withName("separateDepthStencilLayouts"),
        glfw3_h.C_INT.withName("hostQueryReset"),
        glfw3_h.C_INT.withName("timelineSemaphore"),
        glfw3_h.C_INT.withName("bufferDeviceAddress"),
        glfw3_h.C_INT.withName("bufferDeviceAddressCaptureReplay"),
        glfw3_h.C_INT.withName("bufferDeviceAddressMultiDevice"),
        glfw3_h.C_INT.withName("vulkanMemoryModel"),
        glfw3_h.C_INT.withName("vulkanMemoryModelDeviceScope"),
        glfw3_h.C_INT.withName("vulkanMemoryModelAvailabilityVisibilityChains"),
        glfw3_h.C_INT.withName("shaderOutputViewportIndex"),
        glfw3_h.C_INT.withName("shaderOutputLayer"),
        glfw3_h.C_INT.withName("subgroupBroadcastDynamicId"),
        MemoryLayout.paddingLayout(4)

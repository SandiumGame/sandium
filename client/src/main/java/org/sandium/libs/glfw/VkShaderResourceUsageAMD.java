...
public class VkShaderResourceUsageAMD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_INT.withName("numUsedVgprs"),
        glfw3_h.C_INT.withName("numUsedSgprs"),
        glfw3_h.C_INT.withName("ldsSizePerLocalWorkGroup"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_LONG.withName("ldsUsageSizeInBytes"),
        glfw3_h.C_LONG.withName("scratchMemUsageInBytes")

 ...
 * }
 */
public class PFNGLRASTERPOS2XVOESPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLRASTERPOS2XVOESPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLRASTERPOS2XVOESPROC.Function fi, Arena arena) {

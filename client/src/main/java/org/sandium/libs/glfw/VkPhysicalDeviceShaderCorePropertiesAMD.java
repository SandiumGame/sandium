...
public class VkPhysicalDeviceShaderCorePropertiesAMD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("shaderEngineCount"),
        glfw3_h.C_INT.withName("shaderArraysPerEngineCount"),
        glfw3_h.C_INT.withName("computeUnitsPerShaderArray"),
        glfw3_h.C_INT.withName("simdPerComputeUnit"),
        glfw3_h.C_INT.withName("wavefrontsPerSimd"),
        glfw3_h.C_INT.withName("wavefrontSize"),
        glfw3_h.C_INT.withName("sgprsPerSimd"),
        glfw3_h.C_INT.withName("minSgprAllocation"),
        glfw3_h.C_INT.withName("maxSgprAllocation"),
        glfw3_h.C_INT.withName("sgprAllocationGranularity"),
        glfw3_h.C_INT.withName("vgprsPerSimd"),
        glfw3_h.C_INT.withName("minVgprAllocation"),
        glfw3_h.C_INT.withName("maxVgprAllocation"),
        glfw3_h.C_INT.withName("vgprAllocationGranularity")

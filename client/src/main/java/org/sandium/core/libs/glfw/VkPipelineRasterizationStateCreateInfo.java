...
public class VkPipelineRasterizationStateCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("depthClampEnable"),
        glfw3_h.C_INT.withName("rasterizerDiscardEnable"),
        glfw3_h.C_INT.withName("polygonMode"),
        glfw3_h.C_INT.withName("cullMode"),
        glfw3_h.C_INT.withName("frontFace"),
        glfw3_h.C_INT.withName("depthBiasEnable"),
        glfw3_h.C_FLOAT.withName("depthBiasConstantFactor"),
        glfw3_h.C_FLOAT.withName("depthBiasClamp"),
        glfw3_h.C_FLOAT.withName("depthBiasSlopeFactor"),
        glfw3_h.C_FLOAT.withName("lineWidth"),
        MemoryLayout.paddingLayout(4)

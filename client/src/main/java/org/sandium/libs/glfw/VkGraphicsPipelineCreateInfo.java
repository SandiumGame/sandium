...
public class VkGraphicsPipelineCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("stageCount"),
        glfw3_h.C_POINTER.withName("pStages"),
        glfw3_h.C_POINTER.withName("pVertexInputState"),
        glfw3_h.C_POINTER.withName("pInputAssemblyState"),
        glfw3_h.C_POINTER.withName("pTessellationState"),
        glfw3_h.C_POINTER.withName("pViewportState"),
        glfw3_h.C_POINTER.withName("pRasterizationState"),
        glfw3_h.C_POINTER.withName("pMultisampleState"),
        glfw3_h.C_POINTER.withName("pDepthStencilState"),
        glfw3_h.C_POINTER.withName("pColorBlendState"),
        glfw3_h.C_POINTER.withName("pDynamicState"),
        glfw3_h.C_POINTER.withName("layout"),
        glfw3_h.C_POINTER.withName("renderPass"),
        glfw3_h.C_INT.withName("subpass"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("basePipelineHandle"),
        glfw3_h.C_INT.withName("basePipelineIndex"),
        MemoryLayout.paddingLayout(4)

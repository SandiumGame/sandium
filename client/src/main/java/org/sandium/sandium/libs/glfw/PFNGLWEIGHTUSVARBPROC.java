 ...
 * }
 */
public class PFNGLWEIGHTUSVARBPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLWEIGHTUSVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLWEIGHTUSVARBPROC.Function fi, Arena arena) {

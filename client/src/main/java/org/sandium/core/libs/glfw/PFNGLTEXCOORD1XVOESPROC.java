 ...
 * }
 */
public class PFNGLTEXCOORD1XVOESPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLTEXCOORD1XVOESPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLTEXCOORD1XVOESPROC.Function fi, Arena arena) {

 ...
 * }
 */
public class PFNGLNAMEDBUFFERPAGECOMMITMENTEXTPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLNAMEDBUFFERPAGECOMMITMENTEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLNAMEDBUFFERPAGECOMMITMENTEXTPROC.Function fi, Arena arena) {

 ...
 * }
 */
public class PFNGLVERTEXATTRIBL3UI64VNVPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLVERTEXATTRIBL3UI64VNVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLVERTEXATTRIBL3UI64VNVPROC.Function fi, Arena arena) {

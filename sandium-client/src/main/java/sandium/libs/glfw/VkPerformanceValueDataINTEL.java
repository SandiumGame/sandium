...
public class VkPerformanceValueDataINTEL {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        glfw3_h.C_INT.withName("value32"),
        glfw3_h.C_LONG.withName("value64"),
        glfw3_h.C_FLOAT.withName("valueFloat"),
        glfw3_h.C_INT.withName("valueBool"),
        glfw3_h.C_POINTER.withName("valueString")

...
public class VkBindSparseInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("waitSemaphoreCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pWaitSemaphores"),
        glfw3_h.C_INT.withName("bufferBindCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pBufferBinds"),
        glfw3_h.C_INT.withName("imageOpaqueBindCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pImageOpaqueBinds"),
        glfw3_h.C_INT.withName("imageBindCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pImageBinds"),
        glfw3_h.C_INT.withName("signalSemaphoreCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pSignalSemaphores")

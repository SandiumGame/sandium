...
public class VkPhysicalDeviceVulkan11Properties {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("subgroupSupportedStages"),
        glfw3_h.C_INT.withName("subgroupSupportedOperations"),
        glfw3_h.C_INT.withName("subgroupQuadOperationsInAllStages"),
        glfw3_h.C_INT.withName("pointClippingBehavior"),
        glfw3_h.C_INT.withName("maxMultiviewViewCount"),
        glfw3_h.C_INT.withName("maxMultiviewInstanceIndex"),
        glfw3_h.C_INT.withName("protectedNoFault"),
        glfw3_h.C_INT.withName("maxPerSetDescriptors"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_LONG.withName("maxMemoryAllocationSize")

...
public class VkObjectTableDescriptorSetEntryNVX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        vulkan_h.C_POINTER.withName("descriptorSet")
    ).withName("VkObjectTableDescriptorSetEntryNVX");
    ...
    private static final AddressLayout descriptorSet$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("descriptorSet"));
     ...
     * }
     */
    public static final AddressLayout descriptorSet$layout() {
        return descriptorSet$LAYOUT;
    }

    private static final long descriptorSet$OFFSET = 16;
     ...
     * }
     */
    public static MemorySegment descriptorSet(MemorySegment struct) {
     ...
     * }
     */
    public static void descriptorSet(MemorySegment struct, MemorySegment fieldValue) {

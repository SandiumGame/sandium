...
public class VkPipelineLayoutCreateInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("setLayoutCount"),
        glfw3_h.C_POINTER.withName("pSetLayouts"),
        glfw3_h.C_INT.withName("pushConstantRangeCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pPushConstantRanges")

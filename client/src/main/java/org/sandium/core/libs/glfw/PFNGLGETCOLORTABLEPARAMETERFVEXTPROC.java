 ...
 * }
 */
public class PFNGLGETCOLORTABLEPARAMETERFVEXTPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLGETCOLORTABLEPARAMETERFVEXTPROC.Function.class, "apply", $DESC);

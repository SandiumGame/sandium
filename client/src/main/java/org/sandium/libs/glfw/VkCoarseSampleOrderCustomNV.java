...
public class VkCoarseSampleOrderCustomNV {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_INT.withName("shadingRate"),
        glfw3_h.C_INT.withName("sampleCount"),
        glfw3_h.C_INT.withName("sampleLocationCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_POINTER.withName("pSampleLocations")

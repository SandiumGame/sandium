...
public class VkPhysicalDeviceFeatures {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_INT.withName("robustBufferAccess"),
        glfw3_h.C_INT.withName("fullDrawIndexUint32"),
        glfw3_h.C_INT.withName("imageCubeArray"),
        glfw3_h.C_INT.withName("independentBlend"),
        glfw3_h.C_INT.withName("geometryShader"),
        glfw3_h.C_INT.withName("tessellationShader"),
        glfw3_h.C_INT.withName("sampleRateShading"),
        glfw3_h.C_INT.withName("dualSrcBlend"),
        glfw3_h.C_INT.withName("logicOp"),
        glfw3_h.C_INT.withName("multiDrawIndirect"),
        glfw3_h.C_INT.withName("drawIndirectFirstInstance"),
        glfw3_h.C_INT.withName("depthClamp"),
        glfw3_h.C_INT.withName("depthBiasClamp"),
        glfw3_h.C_INT.withName("fillModeNonSolid"),
        glfw3_h.C_INT.withName("depthBounds"),
        glfw3_h.C_INT.withName("wideLines"),
        glfw3_h.C_INT.withName("largePoints"),
        glfw3_h.C_INT.withName("alphaToOne"),
        glfw3_h.C_INT.withName("multiViewport"),
        glfw3_h.C_INT.withName("samplerAnisotropy"),
        glfw3_h.C_INT.withName("textureCompressionETC2"),
        glfw3_h.C_INT.withName("textureCompressionASTC_LDR"),
        glfw3_h.C_INT.withName("textureCompressionBC"),
        glfw3_h.C_INT.withName("occlusionQueryPrecise"),
        glfw3_h.C_INT.withName("pipelineStatisticsQuery"),
        glfw3_h.C_INT.withName("vertexPipelineStoresAndAtomics"),
        glfw3_h.C_INT.withName("fragmentStoresAndAtomics"),
        glfw3_h.C_INT.withName("shaderTessellationAndGeometryPointSize"),
        glfw3_h.C_INT.withName("shaderImageGatherExtended"),
        glfw3_h.C_INT.withName("shaderStorageImageExtendedFormats"),
        glfw3_h.C_INT.withName("shaderStorageImageMultisample"),
        glfw3_h.C_INT.withName("shaderStorageImageReadWithoutFormat"),
        glfw3_h.C_INT.withName("shaderStorageImageWriteWithoutFormat"),
        glfw3_h.C_INT.withName("shaderUniformBufferArrayDynamicIndexing"),
        glfw3_h.C_INT.withName("shaderSampledImageArrayDynamicIndexing"),
        glfw3_h.C_INT.withName("shaderStorageBufferArrayDynamicIndexing"),
        glfw3_h.C_INT.withName("shaderStorageImageArrayDynamicIndexing"),
        glfw3_h.C_INT.withName("shaderClipDistance"),
        glfw3_h.C_INT.withName("shaderCullDistance"),
        glfw3_h.C_INT.withName("shaderFloat64"),
        glfw3_h.C_INT.withName("shaderInt64"),
        glfw3_h.C_INT.withName("shaderInt16"),
        glfw3_h.C_INT.withName("shaderResourceResidency"),
        glfw3_h.C_INT.withName("shaderResourceMinLod"),
        glfw3_h.C_INT.withName("sparseBinding"),
        glfw3_h.C_INT.withName("sparseResidencyBuffer"),
        glfw3_h.C_INT.withName("sparseResidencyImage2D"),
        glfw3_h.C_INT.withName("sparseResidencyImage3D"),
        glfw3_h.C_INT.withName("sparseResidency2Samples"),
        glfw3_h.C_INT.withName("sparseResidency4Samples"),
        glfw3_h.C_INT.withName("sparseResidency8Samples"),
        glfw3_h.C_INT.withName("sparseResidency16Samples"),
        glfw3_h.C_INT.withName("sparseResidencyAliased"),
        glfw3_h.C_INT.withName("variableMultisampleRate"),
        glfw3_h.C_INT.withName("inheritedQueries")

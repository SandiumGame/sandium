 ...
 * }
 */
public class PFNGLPROGRAMUNIFORM1UI64VNVPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLPROGRAMUNIFORM1UI64VNVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLPROGRAMUNIFORM1UI64VNVPROC.Function fi, Arena arena) {

...
public class VkPhysicalDeviceTexelBufferAlignmentPropertiesEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_LONG.withName("storageTexelBufferOffsetAlignmentBytes"),
        glfw3_h.C_INT.withName("storageTexelBufferOffsetSingleTexelAlignment"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_LONG.withName("uniformTexelBufferOffsetAlignmentBytes"),
        glfw3_h.C_INT.withName("uniformTexelBufferOffsetSingleTexelAlignment"),
        MemoryLayout.paddingLayout(4)
    ).withName("VkPhysicalDeviceTexelBufferAlignmentPropertiesEXT");

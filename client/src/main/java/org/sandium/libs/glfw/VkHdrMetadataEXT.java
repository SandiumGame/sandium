...
public class VkHdrMetadataEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_FLOAT.withName("maxLuminance"),
        glfw3_h.C_FLOAT.withName("minLuminance"),
        glfw3_h.C_FLOAT.withName("maxContentLightLevel"),
        glfw3_h.C_FLOAT.withName("maxFrameAverageLightLevel")

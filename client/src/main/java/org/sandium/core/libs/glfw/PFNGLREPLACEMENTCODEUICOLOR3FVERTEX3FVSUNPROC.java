 ...
 * }
 */
public class PFNGLREPLACEMENTCODEUICOLOR3FVERTEX3FVSUNPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLREPLACEMENTCODEUICOLOR3FVERTEX3FVSUNPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLREPLACEMENTCODEUICOLOR3FVERTEX3FVSUNPROC.Function fi, Arena arena) {

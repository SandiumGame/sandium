 ...
 * }
 */
public class PFNGLGETPIXELTRANSFORMPARAMETERFVEXTPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLGETPIXELTRANSFORMPARAMETERFVEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETPIXELTRANSFORMPARAMETERFVEXTPROC.Function fi, Arena arena) {

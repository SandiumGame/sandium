 ...
 * }
 */
public class PFNGLWEIGHTFVARBPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLWEIGHTFVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLWEIGHTFVARBPROC.Function fi, Arena arena) {

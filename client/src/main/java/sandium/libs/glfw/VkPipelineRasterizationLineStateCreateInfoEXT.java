...
public class VkPipelineRasterizationLineStateCreateInfoEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_INT.withName("lineRasterizationMode"),
        glfw3_h.C_INT.withName("stippledLineEnable"),
        glfw3_h.C_INT.withName("lineStippleFactor"),
        glfw3_h.C_SHORT.withName("lineStipplePattern"),

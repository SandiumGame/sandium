...
public class VkPhysicalDeviceLimits {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glfw3_h.C_INT.withName("maxImageDimension1D"),
        glfw3_h.C_INT.withName("maxImageDimension2D"),
        glfw3_h.C_INT.withName("maxImageDimension3D"),
        glfw3_h.C_INT.withName("maxImageDimensionCube"),
        glfw3_h.C_INT.withName("maxImageArrayLayers"),
        glfw3_h.C_INT.withName("maxTexelBufferElements"),
        glfw3_h.C_INT.withName("maxUniformBufferRange"),
        glfw3_h.C_INT.withName("maxStorageBufferRange"),
        glfw3_h.C_INT.withName("maxPushConstantsSize"),
        glfw3_h.C_INT.withName("maxMemoryAllocationCount"),
        glfw3_h.C_INT.withName("maxSamplerAllocationCount"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_LONG.withName("bufferImageGranularity"),
        glfw3_h.C_LONG.withName("sparseAddressSpaceSize"),
        glfw3_h.C_INT.withName("maxBoundDescriptorSets"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorSamplers"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorUniformBuffers"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorStorageBuffers"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorSampledImages"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorStorageImages"),
        glfw3_h.C_INT.withName("maxPerStageDescriptorInputAttachments"),
        glfw3_h.C_INT.withName("maxPerStageResources"),
        glfw3_h.C_INT.withName("maxDescriptorSetSamplers"),
        glfw3_h.C_INT.withName("maxDescriptorSetUniformBuffers"),
        glfw3_h.C_INT.withName("maxDescriptorSetUniformBuffersDynamic"),
        glfw3_h.C_INT.withName("maxDescriptorSetStorageBuffers"),
        glfw3_h.C_INT.withName("maxDescriptorSetStorageBuffersDynamic"),
        glfw3_h.C_INT.withName("maxDescriptorSetSampledImages"),
        glfw3_h.C_INT.withName("maxDescriptorSetStorageImages"),
        glfw3_h.C_INT.withName("maxDescriptorSetInputAttachments"),
        glfw3_h.C_INT.withName("maxVertexInputAttributes"),
        glfw3_h.C_INT.withName("maxVertexInputBindings"),
        glfw3_h.C_INT.withName("maxVertexInputAttributeOffset"),
        glfw3_h.C_INT.withName("maxVertexInputBindingStride"),
        glfw3_h.C_INT.withName("maxVertexOutputComponents"),
        glfw3_h.C_INT.withName("maxTessellationGenerationLevel"),
        glfw3_h.C_INT.withName("maxTessellationPatchSize"),
        glfw3_h.C_INT.withName("maxTessellationControlPerVertexInputComponents"),
        glfw3_h.C_INT.withName("maxTessellationControlPerVertexOutputComponents"),
        glfw3_h.C_INT.withName("maxTessellationControlPerPatchOutputComponents"),
        glfw3_h.C_INT.withName("maxTessellationControlTotalOutputComponents"),
        glfw3_h.C_INT.withName("maxTessellationEvaluationInputComponents"),
        glfw3_h.C_INT.withName("maxTessellationEvaluationOutputComponents"),
        glfw3_h.C_INT.withName("maxGeometryShaderInvocations"),
        glfw3_h.C_INT.withName("maxGeometryInputComponents"),
        glfw3_h.C_INT.withName("maxGeometryOutputComponents"),
        glfw3_h.C_INT.withName("maxGeometryOutputVertices"),
        glfw3_h.C_INT.withName("maxGeometryTotalOutputComponents"),
        glfw3_h.C_INT.withName("maxFragmentInputComponents"),
        glfw3_h.C_INT.withName("maxFragmentOutputAttachments"),
        glfw3_h.C_INT.withName("maxFragmentDualSrcAttachments"),
        glfw3_h.C_INT.withName("maxFragmentCombinedOutputResources"),
        glfw3_h.C_INT.withName("maxComputeSharedMemorySize"),
        MemoryLayout.sequenceLayout(3, glfw3_h.C_INT).withName("maxComputeWorkGroupCount"),
        glfw3_h.C_INT.withName("maxComputeWorkGroupInvocations"),
        MemoryLayout.sequenceLayout(3, glfw3_h.C_INT).withName("maxComputeWorkGroupSize"),
        glfw3_h.C_INT.withName("subPixelPrecisionBits"),
        glfw3_h.C_INT.withName("subTexelPrecisionBits"),
        glfw3_h.C_INT.withName("mipmapPrecisionBits"),
        glfw3_h.C_INT.withName("maxDrawIndexedIndexValue"),
        glfw3_h.C_INT.withName("maxDrawIndirectCount"),
        glfw3_h.C_FLOAT.withName("maxSamplerLodBias"),
        glfw3_h.C_FLOAT.withName("maxSamplerAnisotropy"),
        glfw3_h.C_INT.withName("maxViewports"),
        MemoryLayout.sequenceLayout(2, glfw3_h.C_INT).withName("maxViewportDimensions"),
        MemoryLayout.sequenceLayout(2, glfw3_h.C_FLOAT).withName("viewportBoundsRange"),
        glfw3_h.C_INT.withName("viewportSubPixelBits"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_LONG.withName("minMemoryMapAlignment"),
        glfw3_h.C_LONG.withName("minTexelBufferOffsetAlignment"),
        glfw3_h.C_LONG.withName("minUniformBufferOffsetAlignment"),
        glfw3_h.C_LONG.withName("minStorageBufferOffsetAlignment"),
        glfw3_h.C_INT.withName("minTexelOffset"),
        glfw3_h.C_INT.withName("maxTexelOffset"),
        glfw3_h.C_INT.withName("minTexelGatherOffset"),
        glfw3_h.C_INT.withName("maxTexelGatherOffset"),
        glfw3_h.C_FLOAT.withName("minInterpolationOffset"),
        glfw3_h.C_FLOAT.withName("maxInterpolationOffset"),
        glfw3_h.C_INT.withName("subPixelInterpolationOffsetBits"),
        glfw3_h.C_INT.withName("maxFramebufferWidth"),
        glfw3_h.C_INT.withName("maxFramebufferHeight"),
        glfw3_h.C_INT.withName("maxFramebufferLayers"),
        glfw3_h.C_INT.withName("framebufferColorSampleCounts"),
        glfw3_h.C_INT.withName("framebufferDepthSampleCounts"),
        glfw3_h.C_INT.withName("framebufferStencilSampleCounts"),
        glfw3_h.C_INT.withName("framebufferNoAttachmentsSampleCounts"),
        glfw3_h.C_INT.withName("maxColorAttachments"),
        glfw3_h.C_INT.withName("sampledImageColorSampleCounts"),
        glfw3_h.C_INT.withName("sampledImageIntegerSampleCounts"),
        glfw3_h.C_INT.withName("sampledImageDepthSampleCounts"),
        glfw3_h.C_INT.withName("sampledImageStencilSampleCounts"),
        glfw3_h.C_INT.withName("storageImageSampleCounts"),
        glfw3_h.C_INT.withName("maxSampleMaskWords"),
        glfw3_h.C_INT.withName("timestampComputeAndGraphics"),
        glfw3_h.C_FLOAT.withName("timestampPeriod"),
        glfw3_h.C_INT.withName("maxClipDistances"),
        glfw3_h.C_INT.withName("maxCullDistances"),
        glfw3_h.C_INT.withName("maxCombinedClipAndCullDistances"),
        glfw3_h.C_INT.withName("discreteQueuePriorities"),
        MemoryLayout.sequenceLayout(2, glfw3_h.C_FLOAT).withName("pointSizeRange"),
        MemoryLayout.sequenceLayout(2, glfw3_h.C_FLOAT).withName("lineWidthRange"),
        glfw3_h.C_FLOAT.withName("pointSizeGranularity"),
        glfw3_h.C_FLOAT.withName("lineWidthGranularity"),
        glfw3_h.C_INT.withName("strictLines"),
        glfw3_h.C_INT.withName("standardSampleLocations"),
        MemoryLayout.paddingLayout(4),
        glfw3_h.C_LONG.withName("optimalBufferCopyOffsetAlignment"),
        glfw3_h.C_LONG.withName("optimalBufferCopyRowPitchAlignment"),
        glfw3_h.C_LONG.withName("nonCoherentAtomSize")

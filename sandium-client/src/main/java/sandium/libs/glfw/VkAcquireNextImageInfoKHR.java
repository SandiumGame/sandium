...
public class VkAcquireNextImageInfoKHR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glfw3_h.C_POINTER.withName("swapchain"),
        glfw3_h.C_LONG.withName("timeout"),
        glfw3_h.C_POINTER.withName("semaphore"),
        glfw3_h.C_POINTER.withName("fence"),
        glfw3_h.C_INT.withName("deviceMask"),
        MemoryLayout.paddingLayout(4)

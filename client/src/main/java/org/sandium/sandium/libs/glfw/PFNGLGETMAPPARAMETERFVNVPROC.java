 ...
 * }
 */
public class PFNGLGETMAPPARAMETERFVNVPROC {
    ...
    private static final MethodHandle UP$MH = glfw3_h.upcallHandle(PFNGLGETMAPPARAMETERFVNVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETMAPPARAMETERFVNVPROC.Function fi, Arena arena) {
